            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-8">
                ...
                <div class="bg-white overflow-hidden">
                    <ul class="divide-y divide-gray-200">
                        <x-recent-booking-item activity="Praktikum Basis Data" location="Lab. Basis Data B"
                            date="15 Sep 2025, 08:00-10:00" status="approved" statusText="Disetujui" />

                        <x-recent-booking-item activity="Workshop Pemrograman" location="Lab. Komputer"
                            date="16 Sep 2025, 13:00-15:00" status="pending" statusText="Pending" />

                        <x-recent-booking-item activity="Praktikum Jaringan Dasar" location="Lab. Komputer Jaringan"
                            date="17 Sep 2025, 10:00-12:00" status="approved" statusText="Disetujui" />
                    </ul>
                </div>
            </div>
        </div>
