            ...
            <div class="bg-white p-4 rounded-lg shadow mb-6">
                <form action="{{ route('borrowing.index') }}" method="GET" class="flex flex-col sm:flex-row gap-4">
                        ...
                        <select id="laboratorium" name="laboratorium"
                            ...
                            @foreach ($laboratorium as $lab)
                                <option value="{{ $lab->id_laboratorium }}"
                                    {{ request('laboratorium') == $lab->id_laboratorium ? 'selected' : '' }}>
                    ...
                    <div class="flex-1">
                        ...
                        <select id="tanggal" name="tanggal"
                            ...
                            @foreach ($tanggal_peminjaman as $date)
                                <option value="{{ $date->tanggal }}"
                                    {{ request('tanggal') == $date->tanggal ? 'selected' : '' }}>
                                    {{ $date->tanggal }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="flex items-end gap-2">
                        <button type="submit"
                            class="px-5 py-2 bg-primary text-white text-sm rounded-lg ">
                            Terapkan
                        </button>
